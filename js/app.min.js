...
const transperencyGroup = document.querySelectorAll('._trs-coin-default img');
if (transperencyGroup.length > 0) {
    let trsCoinParallax;
    const transparencyBody = document.querySelector('.transparancy__body');
    function parallaxMob(media) {
        if (!media.matches) {
            transparencyBody.classList.add('_parallax');
            trsCoinParallax = new simpleParallax(transperencyGroup, {
                orientation: 'up left',
                // orientation: 'down',
                scale: 2,
                overflow: true,
            ...
            if (transparencyBody.classList.contains('_parallax')) {
                transparencyBody.classList.remove('_parallax');
                trsCoinParallax.destroy();
            }
        }
    }
...
/* new Rellax('._trs-coin-default', {
    // wrapper:'.test-mediation__body',
    wrapper: '.test-mediation__body'
});
