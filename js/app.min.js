...
$(document).ready(function () {
  if (document.querySelector('.cat-animation__truck')) {
    _runCat.init();
  }
  if (document.querySelector('.fullscreen__cat-coin')) {
    _coinAnimation.init();
  }
  if (document.querySelector('.cat-animation__truck') || document.querySelector('.fullscreen__cat-coin')) {
    console.clear();
  }
});
